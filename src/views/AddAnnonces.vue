      ...
      <div class="home-img">
        ...
        <form id="annonce_form" v-on:submit.prevent="addAnnonce">
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="annonceMv" v-model="annonce.maison" required>
          ...
          <div class="form-group">
            <label>Surface</label>
            <input class="form-control" id="surface" v-model="annonce.surface" required />
          </div>
          <div class="form-group">
            <label>Pieces</label>
          ...
          <div class="form-group">
            ...
            <select class="form-control" id="energie" v-model="annonce.energie" required>
              <option>A</option>
              <option>B</option>
              <option>C</option>
              <option>D</option>
